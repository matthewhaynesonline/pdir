...
The easiest way to install `pdir` is from the [GitHub Releases page](https://github.com/matthewhaynesonline/pdir/releases).
...
See the [Releases page](https://github.com/matthewhaynesonline/pdir/releases) for more information.
